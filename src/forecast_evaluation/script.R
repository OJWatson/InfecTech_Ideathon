...
## Read forecasts
fc_ets <- read_csv("src/time_series_analysis_forecast/outputs/output_fc_ets.csv")
fc_arima <- read_csv("src/time_series_analysis_forecast/outputs/output_fc_arima.csv")
fc_arima_tweet <- read_csv("src/time_series_analysis_forecast/outputs/output_fc_arima_tweet.csv")
fc_ensemble <- read_csv("src/time_series_analysis_forecast/outputs/output_fc_ensemble.csv")
